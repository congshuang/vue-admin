...
export const TEXTAPI = '/api';
export const TOKENAPI = '/tk';

export const LOGIN = CONTEXT + '/login';
export const TEXT = TEXTAPI + '/v1/matter/maxversion';
export const ADD = TEXTAPI + '/v1/matter/matters_after';
export const TOKEN = TOKENAPI + '/v1/oauth2/access_token?grant_type=client_credentials';
...
export const SYS_MENU_LIST_ONE = CONTEXT + '/sys/menu/list1';
