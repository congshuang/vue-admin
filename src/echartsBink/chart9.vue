    ...
    data: function () {
      return {
        dataModel : {
          xAxis: [],
          getFieldCount: [], //获取字段
          shareFieldCount: [], //共享字段
          registryCount: [], //注册量
          loginCount: [], //登录量
          stayTimeCount: [], //停留时间
        },
        showLoading:this.param9,
        indexNames:  ['getFieldCount', 'shareFieldCount', 'registryCount', 'loginCount', 'stayTimeCount'],
        indexChineseNames :  ['获取字段', '共享字段', '注册量', '登录量', '停留时间'],
        lineWidth : 2
      }
    },
    computed: {
